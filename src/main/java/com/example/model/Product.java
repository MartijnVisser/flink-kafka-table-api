...
/** Model class representing a product event from Kafka */
...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1142619296604284127L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.example.model\",\"doc\":\"Model class representing a product event from Kafka\",\"fields\":[{\"name\":\"product_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Unique identifier for the product\"},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2},\"doc\":\"Price of the product with 2 decimal places\"},{\"name\":\"quantity\",\"type\":\"int\",\"doc\":\"Quantity of the product\"},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"doc\":\"Timestamp when the product event was created\"}]}");
   ...
   */
  public Product(java.lang.String product_id, java.nio.ByteBuffer price, java.lang.Integer quantity, java.time.Instant timestamp) {
   ...
   */
  public static com.example.model.Product.Builder newBuilder() {
    return new com.example.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.model.Product.Builder newBuilder(com.example.model.Product.Builder other) {
    if (other == null) {
      return new com.example.model.Product.Builder();
    } else {
      return new com.example.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.model.Product.Builder newBuilder(com.example.model.Product other) {
    if (other == null) {
      return new com.example.model.Product.Builder();
    } else {
      return new com.example.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder setProductId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder setPrice(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.Product.Builder clearTimestamp() {
